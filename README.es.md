...
|---|---|---|
| 2.644 tests | `python -m pytest --collect-only -q -o addopts=` | la misma cuenta |
| 15.969 líneas de código de producto | `find src -name '*.py' \| xargs cat \| wc -l` | la misma cuenta |
| 42.301 líneas de Python en el árbol | `python scripts/figures.py` | `docs/FIGURES.md`, por área |
