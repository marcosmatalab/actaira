...
|---|---|---|
| **2.726 tests**, ejecutados en Python 3.11, 3.12 y 3.13 | **32 reglas documentadas** en paquetes versionados | **7 comandos de CLI**, una dependencia en tiempo de ejecución |
...
|---|---|---|
| 2.726 tests | `python -m pytest --collect-only -q -o addopts=` | la misma cuenta |
| 15.993 líneas de código de producto | `find src -name '*.py' \| xargs cat \| wc -l` | la misma cuenta |
| 43.728 líneas de Python en el árbol | `python scripts/figures.py` | `docs/FIGURES.md`, por área |
