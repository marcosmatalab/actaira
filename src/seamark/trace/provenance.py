...
class Field:
    ...
    def needs_an_argument(self) -> bool:
        ...
        is a decision somebody made. An Seamark-written field is not.
        """
...
PUBLISHED: tuple[Field, ...] = (
    # -- the document ------------------------------------------------------
    Field("schema_version", Writer.SEAMARK, Travel.CLEAR),
    Field("session_id", Writer.THIRD_PARTY, Travel.DIGESTED),
    Field("source", Writer.SEAMARK, Travel.CLEAR),
    Field("capture_level", Writer.SEAMARK, Travel.CLEAR),
    Field("agent", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("agent.name", Writer.SEAMARK, Travel.CLEAR),
    Field(
    ...
    Field("authenticity", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("authenticity.state", Writer.SEAMARK, Travel.CLEAR),
    Field("authenticity.applies", Writer.SEAMARK, Travel.CLEAR),
    Field("authenticity.reason", Writer.SEAMARK, Travel.CLEAR),
    Field("complete", Writer.SEAMARK, Travel.CLEAR),
    Field("child_returncode", Writer.THIRD_PARTY, Travel.CLEAR, CLOSED_SCALAR),
    Field("events", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("gaps", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("blind_spots", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("blind_spots.what", Writer.SEAMARK, Travel.CLEAR),
    Field("blind_spots.why", Writer.SEAMARK, Travel.CLEAR),
    Field("duplicate_records_collapsed", Writer.SEAMARK, Travel.CLEAR),
    Field("mcp", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("mcp.protocol_revisions_observed", Writer.THIRD_PARTY, Travel.CLEAR, CLOSED_DATE),
    Field("mcp.servers", Writer.SEAMARK, Travel.CLEAR, STRUCTURE),
    Field("mcp.servers.ref", Writer.SEAMARK, Travel.CLEAR),
    ...
    # -- one event ---------------------------------------------------------
    Field("index", Writer.SEAMARK, Travel.CLEAR),
    Field("gen_ai.operation.name", Writer.SEAMARK, Travel.CLEAR),
    ...
    Field("arguments_sha256", Writer.SEAMARK, Travel.CLEAR),
    Field("result_sha256", Writer.SEAMARK, Travel.CLEAR),
    Field("error.type", Writer.SEAMARK, Travel.CLEAR),
    ...
    Field("mcp.result.type_assumed", Writer.SEAMARK, Travel.CLEAR),
    Field("mcp.request.state", Writer.THIRD_PARTY, Travel.DIGESTED),
    # -- one gap -----------------------------------------------------------
    Field("reason", Writer.SEAMARK, Travel.CLEAR),
    Field(
        "detail", Writer.SEAMARK, Travel.CLEAR,
        ...
        "is why this is an Seamark-written field and not a third-party one wearing a "
        "sentence",
    ),
    Field("after_event", Writer.THIRD_PARTY, Travel.DIGESTED),
    Field("after_index", Writer.SEAMARK, Travel.CLEAR),
    Field("after_index_absent", Writer.SEAMARK, Travel.CLEAR),
)
