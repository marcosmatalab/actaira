...
Generated 2026-09-19T11:22:08+00:00 for actaira 3.0.0, at commit ec7001f.
...
- 32 commits, most recent 2026-09-19

## Tests

**2333** tests collected by pytest across 40 files.
...
| `tests/test_defect_ledger.py` | 366 |
...
**139** defects, from `docs/defects.json` (121 entries), found by **19** different mechanisms. **20** are pinned by a named regression test, across 32 tests. 91 were defects in the shipped tool; the rest were found the same way but lived in the measuring apparatus, and each says so.
...
| tests | 45 | 17181 | 9667 | 2715 | 1060 | 3739 |
| scripts | 12 | 4025 | 2580 | 589 | 342 | 514 |
| **total** | 103 | 36975 | 22110 | 6014 | 2602 | 6249 |
