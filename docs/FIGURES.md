...
Generated 2026-09-22T10:40:46+00:00 for actaira 3.0.0, at commit 318bb95.
...
- 42 commits, most recent 2026-09-20

## Tests

**2504** tests collected by pytest across 42 files.
...
| `tests/test_defect_ledger.py` | 512 |
...
| `tests/test_release_check.py` | 22 |
...
**145** defects, from `docs/defects.json` (127 entries), found by **20** different mechanisms. **26** are pinned by a named regression test, across 41 tests. 93 were defects in the shipped tool; the rest were found the same way but lived in the measuring apparatus, and each says so.
...
| tests | 49 | 18671 | 10461 | 3057 | 1187 | 3966 |
| scripts | 12 | 4174 | 2645 | 614 | 387 | 528 |
| **total** | 107 | 38648 | 22975 | 6381 | 2800 | 6492 |
