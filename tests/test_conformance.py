...
from actaira.conformance import DeclarationError, assess, load_text
from actaira.conformance.model import Effect, diff
...
def test_the_separation_itself_is_still_recognised_where_it_is_real():
    ...
    that has to cross."""
    from actaira.conformance.capability import identity_separated
...
def test_an_unclassified_source_does_not_rank_as_harmless():
    ...
    from actaira.conformance.vocabulary import Classification
